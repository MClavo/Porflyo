...
public class DdbPortfolioRepositoryIntegrationTest
        extends PortfolioRepositoryContract
    ...
    @Inject 
    DdbPortfolioRepository injectedRepository;

    
    public DdbPortfolioRepositoryIntegrationTest() {
