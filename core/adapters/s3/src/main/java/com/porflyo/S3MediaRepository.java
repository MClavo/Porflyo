...
public class S3MediaRepository implements MediaRepository {
    ...
    @Inject
    public S3MediaRepository(@Named("lowS3Client") S3Client s3, S3Presigner presigner, S3Config s3Config, S3UrlBuilder s3UrlBuilder) {
        this.s3 = s3;
    ...
    public String resolveUrl(String key) {
        return s3UrlBuilder.buildPublicUrl(key);
    }
